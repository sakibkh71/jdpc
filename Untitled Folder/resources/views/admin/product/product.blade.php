      ...
      <div class="modal-header">
    	...
    	<div class="modal-body">
    		{{ Form::open(['method' => 'PUT','enctype' => 'multipart/form-data','class' => 'form-horizontal', 'url' => "admin/product/0"]) }}
                ...
                {{-- <div class="form-group">
                    <label for="edit_features" class="col-md-4 control-label">Product Features</label>
                    <div class="col-md-6">
                        <textarea id="edit_features" type="text" class="form-control" name="edit_features">{{ old('edit_features') }}</textarea>
                    </div>
                </div> --}}

                {{-- <div class="form-group">
                    <label for="edit_stall_location" class="col-md-4 control-label">Stall Location</label>
                    <div class="col-md-6">
                        <textarea id="edit_stall_location" type="text" class="form-control" name="edit_stall_location">{{ old('edit_stall_location') }}</textarea>
                    </div>
                </div> --}}
                ...
                {{-- <div class="form-group">
                    <label for="photos2" class="col-md-4 control-label">Image 02</label>
                    <div class="col-md-6">
                        <input type="file" name="photos2" id="">
                        <span style="color:green;" id="edit_photos2"></span>
                    </div>
                </div> --}}
